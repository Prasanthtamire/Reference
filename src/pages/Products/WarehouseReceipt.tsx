...
import warehouse1 from '../../../src/projectimages/digitalreceipt1.webp';
import warehouse2 from '../../../src/projectimages/Inventory Verification.jpg';
import warehouse3 from '../../../src/projectimages/Automated Financing Flow.jpg';

const WarehouseReceipt = () => {
  const features = [
    {
        src: warehouse1,
        title: "Digital Warehouse Receipts",
        desc: "Secure digitization of receipts to support collateral-backed financing."
      },
      {
        src: warehouse2,
        title: "Inventory Verification",
        desc: "Track and validate stored goods in real-time for lenders and borrowers."
      },
      {
        src: warehouse3,
        title: "Automated Financing Flow",
        desc: "Instant loan approvals based on verified warehouse documentation."
      }
  ];
        ...
        >
          ...
          <p className="main-description">
            Jayam Solutions offers advanced HRM and payroll systems designed to streamline HR processes, improve employee engagement, and ensure error-free payroll operations. Our solutions are tailored to meet both SME and enterprise needs.
             ...
             <h2 className="section-heading ">Transforming Your Warehouse Receipt Financing Software From
             Average To Extraordinary</h2>
          <p className="main-description2">
          In this digital era, Storing and Managing your inventory manually has become
problematic to solve this problem Jayam Solutions has come up with creative
Warehouse Receipt Financing Software Solutions. This is suitable for your needs
of Warehouse Receipt Financing Software and it has features of Automated
Inventory Management, Real-time tracking, Barcode and RFID integration,
Seamless workflow, and Risk management.          </p>
      ...
      <section className="intro-section detailed-text-section  mx-auto ">
        ...
        >
          ...
          <h3 className="subheading">Top Reasons to Take Warehouse Receipt Financing Software from
          Jayam Solutions</h3> 
