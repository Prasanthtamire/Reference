...
import gold1 from '../../../src/projectimages/Instant Loan Processing.webp';
import gold2 from '../../../src/projectimages/Secure Collateral Handling.jpg';
import gold3 from '../../../src/projectimages/Integrated Document Management.png';
  ...
  const features = [
    {
        ...
        desc: "Streamlined process from gold evaluation to loan disbursement."
      },
      {
        src: gold2,
        title: "Secure Collateral Handling",
        desc: "Digitized vault management for secure and auditable transactions."
      },
      {
        src: gold3,
        title: "Integrated Document Management",
        desc: "Auto-generated loan documents, receipts, and compliance reports."
      }
  ];
