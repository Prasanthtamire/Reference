...
import coreBank1 from '../../../src/projectimages/realtime transactions.webp';
import coreBank2 from '../../../src/projectimages/Securescalable.jpg';
import coreBank3 from '../../../src/projectimages/247 net access.webp';
  ...
  const features = [
    {
        ...
        desc: "Process transactions instantly across all branches and digital channels."
      },
      {
        src: coreBank2,
        title: "Secure & Scalable",
        desc: "Robust architecture with high-level encryption and scalability."
      },
      {
        src: coreBank3,
        title: "24/7 Banking Access",
        desc: "Enable customers to access services anytime, anywhere via mobile and web."
      }
  ];
